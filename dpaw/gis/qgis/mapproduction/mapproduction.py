...
from qgis.PyQt.QtWidgets import QAction, QApplication, QDialog, QFormLayout, QGroupBox, QHBoxLayout, QLabel, QLineEdit, QMessageBox, QPushButton, QRadioButton, QVBoxLayout
...
class MapProduction(QObject):
    ...
    def createMap(self, dlg):
        ...
        for id in ids:
            registryLayer = QgsProject.instance().mapLayer(id)
    ...
    def createLocalityMap(self, localityMap, mainMap):
        ...
        if "Locality Map Layers" not in dataLegend.groups():      
            ...
            if stateBoundary is not None:
                QgsProject.instance().addMapLayer(stateBoundary)
            ...
            if lgas is not None:
                QgsProject.instance().addMapLayer(lgas)
            ...
            if localities is not None:
                QgsProject.instance().addMapLayer(localities)

...
from qgis.PyQt.QtWidgets import QAction, QApplication, QBoxLayout, QComboBox, QDialog, QDockWidget, QLabel, QLineEdit, QMenu, QMenuBar, QMessageBox, QPushButton, QToolBar, QVBoxLayout, QWidget
from qgis.PyQt.QtXml import *   # For QDomDocument (to read map composer template)
...
class DockableWindow():
    ...
    # metadata
            ...
            Tools.iface.addCustomActionForLayerType(clmd, "Legacy Metadata", QgsMapLayer.VectorLayer, True)
            #legendInterface.addLegendLayerAction(vlmd, "Legacy Metadata", "vlmd", QgsMapLayer.VectorLayer, True)
            Tools.iface.addCustomActionForLayerType(vlmd, "Legacy Metadata", QgsMapLayer.VectorLayer, True)
            #legendInterface.addLegendLayerAction(elmd, "Legacy Metadata", "elmd", QgsMapLayer.VectorLayer, True)
            Tools.iface.addCustomActionForLayerType(elmd, "Legacy Metadata", QgsMapLayer.VectorLayer, True)
            #legendInterface.addLegendLayerAction(vmd, "Metadata", "vmd", QgsMapLayer.VectorLayer, True)
            Tools.iface.addCustomActionForLayerType(vmd, "Metadata", QgsMapLayer.VectorLayer, True)
            Tools.vmd = vmd
